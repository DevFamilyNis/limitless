...
# Additional Project Standards (Strict Mode)

This section extends the Laravel Boost guidelines with stricter architectural,
typing, and documentation rules. These rules are mandatory unless explicitly stated otherwise.
...
- Domain exceptions should be explicit and meaningful.
- Avoid returning false on failure — throw a typed exception instead.
- Custom exceptions must extend a project base exception if one exists.
