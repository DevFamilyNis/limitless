<div class="mx-auto w-full max-w-3xl">
    <div class="mb-6 flex items-center justify-between">
        <flux:heading size="xl">{{ $isEditing ? 'Izmena prioriteta' : 'Novi prioritet' }}</flux:heading>
        <flux:button variant="ghost" :href="route('settings.issue-priorities.index')" wire:navigate>Nazad</flux:button>
    </div>
