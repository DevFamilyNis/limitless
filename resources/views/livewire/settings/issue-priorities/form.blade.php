<div class="mx-auto w-full max-w-3xl">
    <div class="mb-6 flex items-center justify-between">
        <flux:heading size="xl">{{ $isEditing ? __('messages.settings.issue_priorities.edit_title') : __('messages.settings.issue_priorities.new_title') }}</flux:heading>
        <flux:button variant="ghost" :href="route('settings.issue-priorities.index')" wire:navigate>@lang('messages.actions.back')</flux:button>
    </div>
